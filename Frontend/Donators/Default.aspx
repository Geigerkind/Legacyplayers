<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Donators_Default" %>
    ...
    <table class="table noborder bbdesign" style="margin-top: 20px;">
        <thead>
            <tr>
                ...
                <td class="ttinytext" style="text-align: left">Type</td>
                <td class="tsmalltext" style="text-align: left">Date</td>
                <td class="tsmallvalue">Amount</td>
            </tr>
        </thead>
        <tbody>
        <%=m_Table.ToString() %>
